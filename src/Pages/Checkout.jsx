...
function Checkout() {
  ...
  // FUNÇÃO PARA ENVIAR E-MAIL DE CONFIRMAÇÃO DO PEDIDO
  const enviarEmailConfirmacao = async (email, nome, numeroPedido, total, itens, formaPagamento) => {
    try {
      const response = await fetch('http://localhost:3333/api/send-order-confirmation', {
        method: 'POST',
        headers: {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="checkout-card">
              ...
              {cupom && (
                <div className="cupom-ativo">
                  ...
                  <button type="button" onClick={removeCupom} className="cupom-remove">
                    ✕
                  </button>
                </div>
              )}
            ...
            <div className="checkout-card">
              ...
              {paymentMethod === 'boleto' && (
                <p className="payment-message">O boleto será enviado para seu e-mail.</p>
              )}
            </div>
