    ...
    html: `
      <div style="font-family: Arial; max-width: 600px; margin: 0 auto; background: #FAF8F5; padding: 20px;">
        ...
        <div style="background: white; padding: 20px; border-radius: 0 0 10px 10px;">
          <p>Olá <strong>${nome}</strong>,</p>
          <p>Seu pedido foi realizado com sucesso e já está sendo preparado com muito carinho!</p>
          ...
          <div style="margin-top: 30px; padding: 15px; background: #e8f0e6; border-radius: 8px; text-align: center;">
            ...
            <a href="http://localhost:5173/meus-pedidos" style="background-color: #6b8c5c; color: white; padding: 10px 20px; text-decoration: none; border-radius: 8px; display: inline-block; margin-top: 10px;">
              📦 Meus Pedidos
            </a>
          </div>
